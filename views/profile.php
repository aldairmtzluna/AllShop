...
<div class="profile-container">
  ...
  <form action="<?php echo SERVERURL ?>controllers/profileController.php" method="POST" class="form-profile">
    <div class="column-form-profile">
      ...
      <div class="container-items-form">
        ...
        <input type="text" value="<?php echo $row['usuario_usuario']?>" name="usuario_usuario" autocomplete="off">
      </div>
      <div class="container-items-form">
        <label for="">Nombre:</label>
        <input type="text" name="nombre_usuario" value="<?php echo $row ['nombre_usuario']?>" autocomplete="off">
      </div>
      <div class="container-items-form">
      ...
      <div class="container-items-form btn">
        <input type="submit" value="Guardar" name="profile" class="save btn-save" style="margin-top: 5px;">
      </div>
    </div>
  </div>
  <div class="column-form-profile">
    ...
    <div class="file-container">
      ...
      <input id="file" multiple="" name="perfil_usuario" size="6000" type="file" accept="application/pdf,image/x-png,image/gif,image/jpeg,image/jpg,image/tiff">
    </div>
