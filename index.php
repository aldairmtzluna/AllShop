...
<div class="slider-bg">
  <div class="slider-bg-content">
    <div id="container-slider" class="container-slider">
      <a href="javascript: fntExecuteSlide('prev');" class="arrow arrowPrev"><i class="fas fa-chevron-circle-left"></i></a>
      <a href="javascript: fntExecuteSlide('next');" class="arrow arrowNext"><i class="fas fa-chevron-circle-right"></i></a>
      <ul class="listslider">
  ...
  <div class="container-categories">
    ...
    <?php
      ...
      <div class="column-categories">
        <a href="<?php SERVERURL ?>category?asicat=<?php echo $row ['id_categoria'];?>&CT=<?php echo $titleCat?>&AS=<?php echo hash_hmac('sha1', $row['titulo_categoria'], KEY_TOKEN); ?>" class="a-column-categories">
